...
function UpdateProfile() {
  ...
  const getUserDetails = async () => {
    ...
    console.log(result);
    //the data will be pre set in the input box of update form ,so that user know what is he updating
  ...
  //To handle the file select for background wallpaper
  ...
  const updatedata = async () => {
    ...
    await Toast.fire({
      icon: "success",
      title: "Updated the profile successfully, now you will need to login again",
    });
